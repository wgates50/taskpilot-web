...
post('morning-brief', [
    ...
    {'type': 'event_card', 'data': {
        ...
        'in_calendar': True,
        'image_url': 'https://placehold.co/400x200/1e293b/ffffff?text=The+Drama',
    ...
    {'type': 'event_card', 'data': {
        ...
        'image_url': 'https://placehold.co/400x200/7c3aed/ffffff?text=Back+to+the+Future'
    }},
    {'type': 'event_card', 'data': {
        ...
        'image_url': 'https://placehold.co/400x200/6d28d9/ffffff?text=Belle+%26+Sebastian'
    }},
    {'type': 'event_card', 'data': {
        ...
        'in_calendar': True,
        'map_url': "https://www.google.com/maps/place/Ely's+Yard,+Hanbury+Street,+London"
    }},
    ...
    {'type': 'event_card', 'data': {
        ...
        'image_url': 'https://placehold.co/400x200/0f172a/ffffff?text=David+Bowie+Lightroom'
    }},
    {'type': 'event_card', 'data': {
        ...
        'image_url': 'https://placehold.co/400x200/78350f/ffffff?text=MA%2FNA'
    }},
...
post('activity-suggester', [
    ...
    {'type': 'event_card', 'data': {
        ...
        'map_url': 'https://www.google.com/maps/place/Broadway+Market,+London+Fields'
    }},
...
post('weekly-planner', [
    ...
    {'type': 'event_card', 'data': {
        ...
        'map_url': 'https://www.google.com/maps/place/Royal+Academy+of+Arts,+London'
    }},
    {'type': 'event_card', 'data': {
...
post('weekly-london-event-scanner', [
    ...
    {'type': 'event_card', 'data': {
        ...
        'url': 'https://www.timeout.com/london/restaurants',
        'map_url': 'https://www.google.com/maps/search/MA+NA+Restaurant+Mayfair+London',
        'image_url': 'https://placehold.co/400x200/78350f/ffffff?text=MA%2FNA+Japanese'
    }},
